...
#define RSP_OFF_TELEMETRY_FLAGS 29
#define RSP_OFF_PHASE_FLAGS RSP_OFF_TELEMETRY_FLAGS /* Protocol-v2 compatibility name. */
...
#define TELEMETRY_FLAG_SOFTSTART_READY 0x20
#define TELEMETRY_FLAG_VBUS_VALID 0x40
#define TELEMETRY_FLAG_MCSDK_UNITS 0x80
#define TELEMETRY_FLAG_FW_BUILD_VALID 0x10
