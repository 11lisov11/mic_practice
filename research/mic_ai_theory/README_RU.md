...
- `snh_pwm/c6_conformal_reachability/revalidation/` — два независимых полных
  ...
  индивидуальные и агрегированный аудиты, два сохранённых отрицательных этапа и новая
  prospectively locked ревалидация `20260826/20260827`.
  ...
  считаются только исторической диагностикой. Новая ревалидация использует одну
