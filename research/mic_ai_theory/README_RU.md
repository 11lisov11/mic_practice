...
- `snh_pwm/c6_conformal_reachability/revalidation/` — два независимых полных
  слепых исследования `20260810/20260811`, development-серия `20260809`, их
  индивидуальные и агрегированный аудиты, а также два сохранённых отрицательных этапа. В подтверждающих
  сериях использованы 24 разбиения, 400 calibration-блоков, 800 test-блоков и
  траектории по 40 переключений.
