...
def draw_interfaces(p: DualPage) -> None:
    ...
    p.box(725, 580, 400, 105, "Blue Pill USART2", ["PA3 = RX commands", "PA2 = TX telemetry", "460800 8N1", "CRC/timeout remain active across isolator"], fill="#fff0ef", stroke="#a32b28")
    ...
    p.box(395, 385, 240, 130, "2 x ISO7740FDWR", ["CH0..CH3 via U_LA1", "CH4..CH7 via U_LA2", "EN2 (pin 10) -> SAFE_3V3", "100Mbps / default LOW", "800ns deadtime remains measurable"], fill="#fff7e8", stroke="#b36b16")
